...
def test_oracle(project, gov):
    yfiusd = ape.project.AggregatorV3Interface.at("0xA027702dbb89fbd58938e4324ac03B58d812b0E1")
    ethusd = ape.project.AggregatorV3Interface.at("0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419")
    yfieth = ape.project.AggregatorV3Interface.at("0x7c5d4F8345e66f68099581Db340cd65B078C41f4")
